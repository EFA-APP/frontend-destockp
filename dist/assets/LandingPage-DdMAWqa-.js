...
import { G as Q, C as p } from "./globe-Bl2w_9Wc.js";
import { A as Z } from "./arrow-right-Dfxcx4DJ.js";
import { S as J } from "./search-C04IKVS4.js";
import { L as u } from "./layers-6dPaZyUU.js";
import { S as h } from "./shield-check-Dsqb6bxw.js";
import { B as C } from "./building-2-BD2l287K.js";
import { T } from "./truck-XuAprJVH.js";
import { D as k } from "./database-BZ_VcApS.js";
import { F as X } from "./file-text-CenuHrjT.js";
const Y = [
    [
      "path",
      {
  ...
  ae = {
    "agro-cereales": {
      ...
      icon: e.jsx(k, { className: "w-6 h-6" }),
      ...
      customSections: [
        {
          ...
          icon: e.jsx(u, { className: "w-6 h-6" }),
        },
        {
    ...
    "escuela-futuro": {
      ...
      icon: e.jsx(ee, { className: "w-6 h-6" }),
    ...
    ventryx: {
      ...
      features: [
        ...
        },
        {
          ...
          icon: e.jsx(u, { className: "w-6 h-6 text-white" }),
        },
        {
      ...
      customSections: [
        ...
        },
        {
          ...
          icon: e.jsx(h, { className: "w-6 h-6" }),
        },
      ],
      socials: {
  ...
  he = () => {
    const { slug: S } = W(),
      D = _(),
      [x, L] = c.useState(""),
      [f, B] = c.useState("Todos"),
      [b, se] = c.useState("Sugerido"),
      [l, v] = c.useState(null),
      [q, y] = c.useState(null),
      [oe, G] = c.useState({ nombre: "", email: "", mensaje: "" }),
      [te, A] = c.useState(!1),
      [s, P] = c.useState(null),
      [R, E] = c.useState(!0),
      [I, z] = c.useState(null),
      V = async () => {
        try {
          const { data: a } = await K.get(`/paginas-web/publica/${S}`);
          if (!a.empresa || !a.empresa.paginaWebActiva) {
            (z("Empresa no encontrada o página desactivada"), E(!1));
            return;
          }
          const i = (a.empresa.nombre || "").toLowerCase();
          let d = "";
          i.includes("agro") || i.includes("cereales") || i.includes("pampeana")
            ? (d = "agro-cereales")
            : i.includes("colegio") ||
                i.includes("futuro") ||
                i.includes("escuela")
              ? (d = "escuela-futuro")
              : i.includes("constructora") ||
                  i.includes("omega") ||
                  i.includes("construcciones")
                ? (d = "construcciones-omega")
                : (i.includes("ventryx") || i.includes("technology")) &&
                  (d = "ventryx");
          const g = d ? ae[d] : null;
          let n = {};
          if (a.paginaWeb) {
            const r = a.paginaWeb,
              m = {};
            Array.isArray(r.redesSociales) &&
              r.redesSociales.forEach((o) => {
                o &&
                  o.plataforma &&
                  o.url &&
                  o.visible !== !1 &&
                  (m[o.plataforma.toLowerCase()] = o.url);
              });
            const j = [];
            Array.isArray(r.secciones) &&
              r.secciones
                .filter((o) => o && o.visible !== !1)
                .sort((o, w) => (o.orden || 0) - (w.orden || 0))
                .forEach((o) => {
                  j.push({
                    title: o.titulo || "Sección Especial",
                    content: o.contenido || "",
                    icon: e.jsx(u, { className: "w-6 h-6" }),
                  });
                });
            let N = [];
            if (
              (Array.isArray(r.galeria) &&
                (N = r.galeria
                  .filter((o) => o && o.url && o.visible !== !1)
                  .sort((o, w) => (o.orden || 0) - (w.orden || 0))
                  .map((o) => o.url)),
              (n = {
                name: r.titulo || a.empresa.nombre,
                slogan: r.descripcion || "",
                description: r.descripcion || "",
                history: r.historia || "",
                primaryColor: r.colorPrimario || void 0,
                secondaryColor: r.colorSecundario || void 0,
                bannerImage: r.banner || void 0,
                logoImage: r.logo || void 0,
                favicon: r.favicon || void 0,
                whatsapp:
                  m.whatsapp ||
                  a.empresa.configuracion?.whatsapp ||
                  "5493415550199",
                direccion:
                  m.direccion ||
                  a.empresa.direccion ||
                ...
                correoElectronico:
                  m.email ||
                  a.empresa.correoElectronico ||
                  "contacto@empresa.com",
                telefono: m.telefono || a.empresa.telefono || "5493415550199",
                socials: Object.keys(m).length > 0 ? m : void 0,
                customSections: j.length > 0 ? j : void 0,
                gallery: N.length > 0 ? N : void 0,
              }),
              r.favicon)
            ) {
          ...
          P(
            g
              ? {
                  ...
                  ...a.empresa,
                  ...n,
                  name: n.name || a.empresa.nombre || g.name,
                  products: g.products,
                }
              : {
                  name: n.name || a.empresa.nombre || "Empresa Demostración",
                  slogan:
                    n.slogan ||
                  ...
                  primaryColor: n.primaryColor || "#6366f1",
                  secondaryColor: n.secondaryColor || "#d946ef",
                  category: "Sector General",
                  icon: e.jsx(C, { className: "w-6 h-6" }),
                  whatsapp:
                    a.empresa.configuracion?.whatsapp || "5493415550199",
                  currency: "$",
                  bannerImage:
                    n.bannerImage ||
                  ...
                  customSections: n.customSections || [
                    {
    ...
    const $ = c.useMemo(() => {
        if (!s) return [];
        const a = new Set(s?.products?.map((t) => t.category));
        return ["Todos", ...Array.from(a)];
      }, [s]),
      O = c.useMemo(() => {
        if (!s) return [];
        let a = s.products ? [...s.products] : [];
        if ((f !== "Todos" && (a = a.filter((t) => t.category === f)), x)) {
        ...
        return (
          b === "Precio: Menor a Mayor"
            ? a.sort((t, i) => t.price - i.price)
            : b === "Precio: Mayor a Menor"
              ? a.sort((t, i) => i.price - t.price)
              : b === "Alfabético" &&
                a.sort((t, i) => t.name.localeCompare(i.name)),
          a
        );
      }, [s, f, x, b]);
    if (
      (c.useEffect(() => {
        if (s) {
          ...
          (a.style.setProperty(
            "--primary",
            s?.configuracionVisual?.colorPrimario,
          ),
            a.style.setProperty(
              "--secondary",
              s?.configuracionVisual?.colorSecundario || "#d946ef",
            ));
          const t = s.primaryColor.replace("#", "");
          if (t.length === 6) {
            const i = parseInt(t.substring(0, 2), 16),
              d = parseInt(t.substring(2, 4), 16),
              g = parseInt(t.substring(4, 6), 16);
            a.style.setProperty("--primary-rgb", `${i}, ${d}, ${g}`);
          }
        } else {
          const a = document.documentElement;
          (a.style.setProperty(
            ...
            a.style.setProperty(
              "--secondary",
              s?.configuracionVisual?.colorSecundario,
            ),
            a.style.setProperty("--primary-rgb", "99, 102, 241"));
        }
      }, [s]),
      R)
    )
      return e.jsx("div", {
        className:
          "loading-screen flex items-center justify-center min-h-screen",
        children: e.jsx("div", {
          className: "spinner text-[var(--primary)] text-xl",
          children: "Cargando...",
        }),
      });
    if (I)
      return e.jsx("div", {
        className: "error-screen flex items-center justify-center min-h-screen",
        children: e.jsxs("div", {
          className: "text-center p-8 max-w-md landing-glass rounded-md",
          children: [
            e.jsx(Q, {
              className: "w-16 h-16 mx-auto mb-4 text-rose-500 animate-pulse",
            }),
            e.jsx("h2", {
              className: "text-rose-500 text-2xl font-black mb-3",
              children: "Servicio No Disponible",
            }),
            e.jsx("p", {
              className: "text-sm text-[var(--text-muted)] font-semibold mb-6",
              children: I,
            }),
          ],
        }),
...
• *${a.name}* (${s.currency} ${a.price.toLocaleString("es-AR")} por ${a.unit})

Muchas gracias.`,
          d = `https://wa.me/${s.whatsapp.replace(/[^0-9]/g, "")}?text=${encodeURIComponent(t)}`;
    ...
    return e.jsxs("div", {
      ...
      children: [
        e.jsxs("div", {
          className: "landing-orbs-container",
          children: [
            e.jsx("div", { className: "landing-orb orb-primary" }),
            e.jsx("div", { className: "landing-orb orb-secondary" }),
          ],
        }),
        e.jsxs("div", {
          ...
          children: [
              ...
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx("div", {
                      className:
                        "w-10 h-10 rounded-md flex items-center justify-center text-white shadow-md cursor-pointer transition-all hover:scale-105",
                      style: { backgroundColor: s.primaryColor },
                      onClick: () =>
                        window.scrollTo({ top: 0, behavior: "smooth" }),
                      children: s?.configuracionVisual?.logoUrl
                        ? e.jsx("img", {
                            src: s?.configuracionVisual?.logoUrl,
                            alt: "",
                          })
                        : s?.icon,
                    }),
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx("span", {
                          className:
                            "font-extrabold text-[16px] md:text-[18px] uppercase tracking-tighter text-[var(--text-main)] leading-tight",
                          children: s.name,
                        }),
                        e.jsx("span", {
                          className:
                            "text-[11px] font-black uppercase tracking-widest text-[var(--primary)] leading-none",
                          children: s.category,
                        }),
                      ],
                    }),
            ...
            e.jsxs("header", {
              className:
                "landing-hero-split container mx-auto px-6 py-16 md:py-24 grid grid-cols-1 md:grid-cols-12 gap-12 items-center",
              children: [
                e.jsxs("div", {
                  className:
                    "md:col-span-7 space-y-6 text-left animate-in fade-in slide-in-from-bottom-8 duration-700",
                  children: [
                    e.jsx("span", {
                      className:
                        "inline-block px-3 py-1.5 bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-full text-[12px] font-black uppercase tracking-widest text-[var(--primary)]",
                      children: "Sitio Corporativo Oficial",
                    }),
                    e.jsx("h1", {
                      className:
                        "text-[36px] md:text-[52px] font-black tracking-tight leading-none text-gradient-primary uppercase",
                      children: s.slogan,
                    }),
                    e.jsx("p", {
                      className:
                        "text-base md:text-lg text-[var(--text-muted)] font-medium leading-relaxed max-w-xl",
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs("button", {
                          ...
                          children: [
                            "Ver Catálogo ",
                            e.jsx(Z, { size: 14, className: "ml-2" }),
                          ],
                        }),
                        e.jsx("button", {
                          onClick: () =>
                            document
                              ...
                              .scrollIntoView({ behavior: "smooth" }),
                          className:
                            "landing-btn btn-secondary border border-slate-200 bg-white/50 text-[var(--text-main)] hover:bg-slate-50",
                          children: "Conócenos",
                        }),
                      ],
                    }),
                ...
                e.jsxs("div", {
                  className:
                    "md:col-span-5 relative animate-in fade-in zoom-in-95 duration-1000",
                  children: [
                    e.jsx("div", {
                      className:
                        "hero-image-frame rounded-md overflow-hidden shadow-2xl border border-[var(--glass-border)] bg-[var(--glass-bg)] p-3",
                      children: e.jsx("img", {
                        src: s.bannerImage,
                        alt: s.name,
                        className:
                      ...
                      children: [
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            e.jsx("span", {
                              className:
                                "text-[11px] font-bold text-slate-400 uppercase tracking-widest leading-none",
                              children: "Sitio Corporativo Oficial",
                            }),
                            e.jsx("span", {
                              className:
                                "text-[13px] font-black text-slate-800 uppercase tracking-tight mt-1",
                              children: s.category,
                            }),
                          ],
                        }),
            ...
            e.jsxs("section", {
              id: "about",
              className:
                "landing-section section-about border-t border-[var(--glass-border)] relative overflow-hidden",
              style: {
                background:
              ...
              children: [
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsx("div", {
                      className:
                        "absolute top-0 left-0 w-72 h-72 bg-[var(--primary)]/10 blur-3xl rounded-full",
                    }),
                    e.jsx("div", {
                      className:
                        "absolute bottom-0 right-0 w-72 h-72 bg-[var(--secondary)]/10 blur-3xl rounded-full",
                    }),
                  ],
                }),
                e.jsxs("div", {
                  className:
                    "relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center",
                  children: [
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs("div", {
                          children: [
                            ...
                            e.jsx("h2", {
                              className:
                                "section-title text-[var(--text-main)] mt-4",
                              children: "Nuestra Historia",
                            }),
                            e.jsx("div", {
                              className:
                                "w-20 h-1.5 bg-[var(--primary)] rounded-full mt-4",
                            }),
                          ],
                        }),
                        e.jsx("p", {
                          className:
                            "text-base text-[var(--text-muted)] font-medium leading-relaxed",
                          children: s.history,
                        }),
                        e.jsxs("div", {
                          className:
                          ...
                          children: [
                            e.jsxs("div", {
                              ...
                              children: [
                                e.jsx("h4", {
                                  className:
                                    "text-sm font-black text-[var(--primary)] uppercase tracking-wider mb-2",
                                  children: "Misión",
                                }),
                                e.jsx("p", {
                                  className:
                                    "text-[13px] text-[var(--text-muted)] font-medium leading-relaxed",
                                  children:
                                    "Excelencia operativa en cada entrega e innovación continua en nuestros servicios.",
                                }),
                              ],
                            }),
                            e.jsxs("div", {
                              ...
                              children: [
                                ...
                                e.jsx("p", {
                                  className:
                                    "text-[13px] text-[var(--text-muted)] font-medium leading-relaxed",
                                  children:
                                    "Transparencia, sustentabilidad, calidad humana y compromiso local.",
                                }),
                              ],
                            }),
                          ],
                    ...
                    e.jsx("div", {
                      children: e.jsx("div", {
                        ...
                        children: s.features?.map((a, t) =>
                          e.jsxs(
                            "div",
                            {
                              className:
                                "feature-card-modern text-left flex gap-5 items-start",
                              children: [
                                e.jsx("div", {
                                  className:
                                    "p-4 rounded-md text-white shadow-lg flex-shrink-0",
                                  style: {
                                ...
                                e.jsxs("div", {
                                  children: [
                                    e.jsx("h3", {
                                      className:
                                        "text-base font-black text-[var(--text-main)] uppercase mb-2 tracking-tight",
                                      children: a.title,
                                    }),
                                    e.jsx("p", {
                                      className:
                                        "text-sm text-[var(--text-muted)] leading-relaxed font-medium",
                                      children: a.desc,
                                    }),
                                  ],
                                }),
            ...
            s.customSections?.length > 0 &&
              e.jsxs("section", {
                id: "services",
                className:
                  "landing-section section-services border-t border-[var(--glass-border)] relative overflow-hidden",
                style: {
                  background:
                ...
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("div", {
                        className:
                          "absolute top-10 right-10 w-80 h-80 bg-[var(--primary)] blur-3xl rounded-full",
                      }),
                      e.jsx("div", {
                        className:
                          "absolute bottom-0 left-0 w-72 h-72 bg-[var(--secondary)] blur-3xl rounded-full",
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("span", {
                            className: "section-badge-dark",
                            children: "Especialidades Corporativas",
                          }),
                          e.jsx("h2", {
                            className: "section-title text-white! mt-4",
                            children: "Especialidades & Divisiones",
                          }),
                          e.jsx("p", {
                            className:
                              "section-subtitle mx-auto text-slate-100",
                            children:
                              "Conocé las áreas de servicio e innovación que nos diferencian en el mercado.",
                          }),
                        ],
                      }),
                      e.jsx("div", {
                        className: "grid grid-cols-1 md:grid-cols-2 gap-8",
                        children: s.customSections.map((a, t) =>
                          e.jsxs(
                            "div",
                            {
                              className:
                                "service-card-modern text-left flex gap-6 items-start",
                              children: [
                                e.jsx("div", {
                                ...
                                e.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    e.jsx("p", {
                                      className:
                                        "text-sm text-slate-300 font-medium leading-relaxed",
                                      children: a.content,
                                    }),
                                  ],
                                }),
            ...
            e.jsxs("section", {
              id: "catalog",
              className:
                "landing-section section-catalog border-t border-[var(--glass-border)] relative overflow-hidden",
              style: {
                background:
              ...
              children: [
                e.jsx("div", {
                  ...
                  children: e.jsx("div", {
                    className:
                      "absolute top-0 right-0 w-96 h-96 bg-[var(--primary)]/10 blur-3xl rounded-full",
                  }),
                }),
                e.jsxs("div", {
                  className: "relative z-10",
                  children: [
                    e.jsxs("div", {
                      className:
                        "flex flex-col mb-10 text-center! max-w-2xl mx-auto",
                      children: [
                        e.jsx("span", {
                          className: "section-badge",
                          children: "Catálogo Corporativo",
                        }),
                        e.jsx("h2", {
                          className: "section-title mt-4",
                          children: "Productos e Insumos",
                        }),
                        e.jsx("p", {
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsxs("aside", {
                          className: "catalog-sidebar modern-sidebar",
                          children: [
                            e.jsxs("div", {
                                ...
                                e.jsx("div", {
                                  ...
                                  children: $.map((a) =>
                                    e.jsx(
                                      ...
                                      {
                                        onClick: () => B(a),
                                        className: `category-item ${f === a ? "active" : ""}`,
                                        children: a,
                                      },
                                      a,
                                    ),
                          ...
                          children: e.jsx("div", {
                            ...
                            children: O.map((a) =>
                              e.jsxs(
                                ...
                                {
                                  className:
                                    "product-card-modern cursor-pointer group",
                                  onClick: () => v(a),
                                  children: [
                                    e.jsxs("div", {
                                    ...
                                    e.jsxs("div", {
                                      ...
                                      children: [
                                        e.jsxs("span", {
                                          className:
                                            "text-[11px] font-black uppercase tracking-widest text-[var(--text-muted)] block mb-1",
                                          children: ["Ref: ", a.id],
                                        }),
                                        e.jsx("h3", {
                                          className:
                                            "product-name group-hover:text-[var(--primary)] transition-colors",
                                          children: a.name,
                                        }),
                                        e.jsxs("div", {
            ...
            e.jsxs("section", {
              id: "gallery",
              className:
                "landing-section section-gallery border-t border-[var(--glass-border)] relative overflow-hidden",
              style: {
                background:
              ...
              children: [
                e.jsx("div", {
                  ...
                  children: e.jsx("div", {
                    className:
                      "absolute top-0 left-0 w-80 h-80 bg-[var(--primary)] blur-3xl rounded-full",
                  }),
                }),
                e.jsxs("div", {
                  className: "relative z-10",
                  children: [
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsx("h2", {
                          className: "section-title text-white! mt-4",
                          children: "Galería Institucional",
                        }),
                        e.jsx("p", {
                          className: "section-subtitle mx-auto text-slate-300",
                          children:
                          ...
                          "div",
                          {
                            ...
                            children: [
                              e.jsx("img", {
                                ...
                                alt: `Galería ${t + 1}`,
                                className:
                                  "w-full h-[220px] object-cover transition-all duration-500 group-hover:scale-110",
                              }),
                              e.jsx("div", {
            ...
            e.jsxs("section", {
              id: "contact",
              className:
                "landing-section section-contact border-t border-[var(--glass-border)] relative overflow-hidden",
              style: {
                background:
              ...
              children: [
                e.jsx("div", {
                  ...
                  children: e.jsx("div", {
                    className:
                      "absolute bottom-0 right-0 w-96 h-96 bg-[var(--secondary)]/20 blur-3xl rounded-full",
                  }),
                }),
                e.jsxs("div", {
                  className: "relative z-10",
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        e.jsxs("div", {
                          ...
                          children: [
                            e.jsx("div", { className: "contact-info-modern" }),
                            e.jsx("div", { className: "contact-info-modern" }),
                          ],
                        }),
                      ],
            ...
            e.jsxs("footer", {
              ...
              children: [
                ...
                e.jsx("p", {
                  className:
                    "text-[12px] text-[var(--text-muted)] mt-1 uppercase tracking-widest",
                  children:
        ...
        l &&
          e.jsx("div", {
            className:
              "fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200",
            children: e.jsxs("div", {
              className:
                "bg-white rounded-md max-w-lg w-full overflow-hidden shadow-2xl border border-slate-100 flex flex-col text-left",
              children: [
                e.jsxs("div", {
                  className:
                    "h-[240px] bg-slate-50 flex items-center justify-center border-b border-slate-100 relative overflow-hidden",
                  children: [
                    e.jsx("img", {
                      src:
                        l.image ||
                    ...
                    e.jsx("button", {
                      onClick: () => v(null),
                      className:
                        "absolute top-4 right-4 p-2 bg-white/80 hover:bg-white rounded-full text-slate-800 shadow transition-colors",
                      title: "Cerrar",
                  ...
                  children: [
                      ...
                      children: [
                        e.jsxs("div", {
                          children: [
                            e.jsx("span", {
                              className:
                                "px-2.5 py-0.5 bg-[var(--primary)]/10 text-[var(--primary)] text-[12px] font-black uppercase tracking-wider rounded-md",
                              children: l.category,
                            }),
                            e.jsx("h3", {
                              className:
                                "text-xl font-black text-slate-800 uppercase tracking-tight mt-2",
                              children: l.name,
                            }),
                          ],
                        }),
                        e.jsxs("div", {
                          ...
                          children: [
                            ...
                            e.jsxs("span", {
                              className:
                                "block text-[12px] font-bold text-slate-400",
                              children: ["por ", l.unit],
                            }),
                          ],
                        }),
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx("span", {
                          className:
                            "text-[12px] font-black uppercase tracking-widest text-slate-400 block mb-1",
                          children: "Especificaciones y Disponibilidad",
                        }),
                        e.jsxs("div", {
                          className:
                            "grid grid-cols-2 gap-4 py-2 border-y border-slate-50",
                          children: [
                            e.jsxs("div", {
                              children: [
                                e.jsx("span", {
                                  className:
                                    "text-[12px] text-slate-400 font-semibold",
                                  children: "Estado / Existencia",
                                }),
                                e.jsx("span", {
                                  className:
                                    "block text-sm font-bold text-slate-800 uppercase mt-0.5",
                                  children: l.stock,
                                }),
                              ],
                            }),
                    ...
                    e.jsxs("p", {
                      className:
                        "text-sm text-[var(--text-muted)] font-medium leading-relaxed",
                      children: [
                        "Este producto forma parte de la oferta corporativa oficial de",
                        " ",
                        s.name,
                        ". Si desea solicitar cotizaciones por lotes de gran escala, especificaciones de producción a medida o condiciones de financiamiento comercial, haga clic en el botón de consulta a continuación.",
                      ],
                    }),
                    e.jsxs("div", {
                      ...
                      children: [
                        e.jsx("button", {
                          onClick: () => F(l),
                          className:
                            "flex-grow py-3 bg-[var(--primary)] text-white font-black text-xs uppercase tracking-widest rounded-md transition-all hover:brightness-110 active:scale-98 text-center",
                          children: "Consultar vía WhatsApp",
                        }),
                        e.jsx("button", {
                          onClick: () => v(null),
                          className:
                            "px-6 py-3 border border-slate-200 text-slate-600 font-black text-xs uppercase tracking-widest rounded-md transition-all hover:bg-slate-50",
                          children: "Cerrar",
                        }),
                      ],
                    }),
        ...
        q &&
          e.jsxs("div", {
            className:
              "fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-sm cursor-pointer animate-in fade-in duration-300",
            onClick: () => y(null),
            children: [
              e.jsx("button", {
                className:
                  "absolute top-6 right-6 p-2 bg-white/10 hover:bg-white/20 rounded-full text-white transition-colors",
                onClick: () => y(null),
                title: "Cerrar Zoom",
                children: e.jsx(M, { size: 24 }),
              }),
              e.jsx("img", {
                src: q,
                alt: "Zoom Imagen",
                className:
                  "max-w-full max-h-[85vh] object-contain rounded-md shadow-2xl border border-white/5 animate-in zoom-in-95 duration-300",
              }),
            ],
          }),
      ],
