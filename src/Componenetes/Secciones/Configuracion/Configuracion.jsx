    ...
    <div className="w-full py-6 px-4">
      ...
      <div className="rounded-md p-6 border-0 no-inset no-ring bg-[var(--fill)] px-0 py-0 dark:shadow-dark-md shadow-md">
        <div className="w-full">
          ...
          {/* NAVEGACION MENU */}
          {/* CONTENIDO */}
          <div className="mt-2 ring-offset-border dark:ring-offset-darkborder border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 border-none py-2 px-4">
            {/* GRILLA */}
            <div className="grid grid-cols-12 gap-[10px]">
              ...
              <div className="md:col-span-6 col-span-12 text-bodytext">
                <div className="p-6 bg-[var(--fill2)] dark:bg-darkgray shadow-md dark:shadow-dark-md card undefined border-1! border-[var(--fill2)]! rounded-md">
                  <h5 className="leading-1 font-normal! text-white! text-[17px]!">
                    Cambiar Perfil
                  </h5>
                  <p className="leading-12 font-light text-white/50 text-[13px]!">
                  ...
                  <div className="flex justify-center gap-3 py-6">
                    ...
                    <Boton bg={"bg-red-400!"} texto={"Reiniciar"} />
                  </div>
                </div>
              </div>
              {/* TARJETA DE CAMBIAR IMAGEN */}
              ...
              <div className="md:col-span-6 col-span-12">
                <div className="p-6 text-bodytext bg-[var(--fill2)] shadow-md card h-full  rounded-md border-none">
                  ...
                  <p className="font-light text-white/50 text-[13px]! my-3">
            ...
            <div className="flex justify-end gap-3 w-full pt-5">
              <Boton bg={"bg-[var(--primary)]!"} texto={"Guardar"} />
              <Boton bg={"bg-red-400!"} texto={"Cancelar"} />
            </div>
            {/* BOTONES */}
          </div>
          {/* CONTENIDO */}
