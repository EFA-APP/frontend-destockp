import { Cuenta, Inicio } from "../../assets/Icons";
import BarraNavegacion from "./MenuNavegacion/BarraNavegacion";
        ...
        <div className="w-full py-6 px-6">
          ...
          <div className="rounded-md p-6 text-bodytext border-0 no-inset no-ring bg-[var(--fill)] dark:bg-darkgray mb-[30px] py-4 dark:shadow-dark-md shadow-md">
            <div className="flex items-center justify-between">
              <h6 className="text-md text-white">Configuración</h6>
          ...
          {/* CONTENIDO */}
          <div className="rounded-md p-6 border-0 no-inset no-ring dark:bg-[var(--fill)] px-0 py-0 dark:shadow-dark-md shadow-md">
