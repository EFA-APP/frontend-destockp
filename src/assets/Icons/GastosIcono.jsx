  ...
  return (
    ...
    >
      <g fill="none" stroke={color || "currentColor"} strokeWidth="1">
        ...
        <path d="M16.5 6.5V11.5" strokeLinecap="round" />
        <path d="M16.5 16.5V20.5" strokeLinecap="round" />
        <path d="M17.2002 11.5C17.918 11.5001 18.4999 12.082 18.5 12.7998V15.2002C18.4999 15.918 17.918 16.4999 17.2002 16.5H15.7998C15.082 16.4999 14.5001 15.918 14.5 15.2002V12.7998C14.5001 12.082 15.082 11.5001 15.7998 11.5H17.2002Z" />
      </g>
    </svg>
  );
};
