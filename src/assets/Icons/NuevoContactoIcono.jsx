...
const NuevoContactoIcono = ({ size = 24, color = "currentColor" }) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M15.415 13.507A11.3 11.3 0 0 0 12 13c-3.866 0-7 1.79-7 4c0 2.14 2.942 3.888 6.642 3.995a5 5 0 0 1-.064-.375c-.078-.578-.078-1.283-.078-2.034v-.172c0-.75 0-1.456.078-2.034c.086-.643.293-1.347.874-1.928c.581-.582 1.285-.788 1.928-.875a10 10 0 0 1 1.035-.07"
      />
    </svg>
  );
};

export default NuevoContactoIcono;
