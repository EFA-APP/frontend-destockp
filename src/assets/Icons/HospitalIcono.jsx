...
// colocar size y color, y corregir espacios de guion bajo en camelCase

const HospitalIcono = ({ size = 20, color = "currentColor" }) => {
  return (
    <svg
