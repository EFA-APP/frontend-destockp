...
const SkeletonFilaTabla = () => {
    return (
        <div className="bg-[#181818] rounded-2xl border border-white/10 overflow-hidden shadow-2xl flex flex-col animate-pulse">
            ...
            <div className="p-4 bg-gradient-to-br from-white/[0.06] to-transparent border-b border-white/5">
                <div className="flex items-start justify-between gap-4 mb-2">
                    <div className="flex flex-col gap-3 min-w-0 flex-1">
                        ...
                        <div className="h-3 w-32 bg-white/5 rounded mt-1" />
                    </div>
                    <div className="shrink-0">
                        <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 shadow-inner" />
                    </div>
                </div>
            </div>
