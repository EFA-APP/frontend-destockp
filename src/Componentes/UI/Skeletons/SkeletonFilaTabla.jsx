    ...
    <div className="bg-[#181818] rounded-md border border-black/10 overflow-hidden shadow-2xl flex flex-col ">
      ...
      <div className="p-4 bg-gradient-to-br from-white/[0.06] to-transparent border-b border-black/5">
        <div className="flex items-start justify-between gap-4 mb-2">
          ...
          <div className="shrink-0">
            <div className="w-10 h-10 rounded-md bg-black/5 border border-black/10 shadow-inner" />
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-black/30 flex flex-col gap-2">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div
            key={i}
            className="flex items-center justify-between p-3.5 rounded-md bg-white/[0.02] border border-transparent"
          >
