    ...
    <div className="absolute right-0 top-full mt-3 z-100 w-72 rounded-2xl bg-[var(--surface)] border border-[var(--border-subtle)] shadow-[0_12px_40px_rgba(0,0,0,0.08)] overflow-hidden">
      ...
      <div className="px-5 py-5 border-b border-[var(--border-subtle)] bg-gradient-to-br from-[var(--surface-hover)] to-[var(--fill)]">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-md bg-[var(--primary-subtle)] border border-[var(--primary)]/10 shadow-inner">
            <ConfiguracionIcono size={18} color="var(--primary)" />
          </div>
          <div className="flex flex-col">
            <h3 className="text-[13px] font-black text-[var(--text-primary)] uppercase tracking-widest">
              Configuración
            </h3>
      ...
      <div className="p-3 space-y-1">
        <Link
          ...
          onClick={onClose}
          className="flex items-center gap-4 px-3 py-3 rounded-md transition-all duration-200 hover:bg-[var(--primary-subtle)] group border border-transparent hover:border-[var(--primary)]/10"
        >
      ...
      <div className="px-5 py-3 bg-[var(--fill)] border-t border-[var(--border-subtle)] flex justify-between items-center">
        ...
        <span className="text-[9px] text-[var(--primary)] font-black bg-[var(--primary-subtle)] px-2 py-0.5 rounded-full uppercase tracking-wider">
          v1.0.4
        </span>
      </div>
    </div>
