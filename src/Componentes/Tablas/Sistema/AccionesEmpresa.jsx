...
export const accionesEmpresas = ({
  ...
  ...(handleLogsArcaClick
    ? [
        {
          label: "Historial ARCA",
          icono: (
            <div className="p-1 rounded-md bg-blue-700/10 text-blue-700 hover:bg-blue-700/20">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 2v20"/>
          ...
          mostrar: (fila) => fila.conexionArca === true,
          onClick: (fila) => handleLogsArcaClick(fila),
        },
      ]
    : []),
  ...
  ...(tieneAccion("CONFIGURAR_CAMPOS_EMPRESA")
    ...
    : []),
  ...(tieneAccion("EDITAR_EMPRESA") && handleConfigurarCorreosClick
    ? [
        {
          ...
          onClick: (fila) => handleConfigurarCorreosClick(fila),
        },
      ]
    : []),
