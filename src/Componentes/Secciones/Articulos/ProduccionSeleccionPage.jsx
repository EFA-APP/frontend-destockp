        ...
        <ContenedorSeccion>
            ...
            <div className="max-w-5xl mx-auto space-y-6 pb-20">
                ...
                <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-white/85 group-focus-within:text-purple-500 transition-colors z-10">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-white/85 font-medium">Stock Actual: <span className="text-white/60">{item.stock || 0}</span></p>
                                    </div>
                                </div>
                                <div className="p-2 rounded-md bg-white/5 text-white/85 group-hover:bg-purple-600/20 group-hover:text-purple-400 transition-all">
                                    <ArrowRight size={16} />
                                </div>
                            </div>
                        ))
                ...
                <div className="bg-purple-600/5 border border-purple-500/10 rounded-md p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/85 max-w-md">Seleccione un artículo terminado para desglosar sus insumos y registrar un nuevo lote en el inventario.</p>
                        </div>
                    </div>
                    <button
                        onClick={() => navigate("/panel/inventario/produccion/reporte")}
                        className="px-6 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 rounded-md text-[10px] font-black text-white/85 hover:text-white uppercase tracking-[0.2em] transition-all cursor-pointer active:scale-95"
                    >
