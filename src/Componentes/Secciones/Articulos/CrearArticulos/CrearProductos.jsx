...
const CrearProductos = () => {
  ...
  const handleSubmit = async (data) => {
    try {
      // 1. Construir el objeto de atributos dinámicos (Whitelist de campos dinámicos)
      const atributos = {};
      ...
      // 2. Construir el Payload Final (Whitelist de campos base)
      // Solo tomamos lo que el ActualizarProductoDto / CrearProductoDto espera
      const payload = {
        nombre: data.nombre?.toUpperCase(),
        descripcion: data.descripcion,
        unidadMedida: data.unidadMedida || "FRASCO",
      ...
      if (isEdit) {
        ...
        await actualizarProducto(id, payloadActualizar);
      } else {
