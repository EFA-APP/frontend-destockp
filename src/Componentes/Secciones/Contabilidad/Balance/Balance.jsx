...
import { BalanceIcono } from "../../../../assets/Icons";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      >
        ...
        {/* Filtros */}
        <div
          className="px-6 py-4 flex gap-4 border-b border-gray-700/40 bg-[var(--fill2)]"
        >
          <input
            type="date"
            className="bg-transparent border border-gray-600 rounded-md px-3 py-2 text-sm text-white focus:outline-none focus:border-[var(--color-primary)]"
          />
          <input
            type="date"
            className="bg-transparent border border-gray-600 rounded-md px-3 py-2 text-sm text-white focus:outline-none focus:border-[var(--color-primary)]"
        ...
        {/* Estado del balance */}
        <div
          className="bg-[var(-fill2)] px-6 py-4 border-t border-gray-700/40 flex justify-between items-center"
        >
