 ...
 */
export const obtenerComprobantesPermitidos = (condicionEmisor, condicionReceptor) => {
 ...
 */
export const obtenerAjusteCorrespondiente = (tipoOriginal, tipoAjuste = 'NC') => {
  const tipo = Number(tipoOriginal);
  
  const mapa = {
    // Original -> [NC, ND, RECIBO]
    [TIPO_COMPROBANTE.FACTURA_A]: [TIPO_COMPROBANTE.NC_A, TIPO_COMPROBANTE.ND_A, TIPO_COMPROBANTE.RECIBO_A],
    [TIPO_COMPROBANTE.FACTURA_B]: [TIPO_COMPROBANTE.NC_B, TIPO_COMPROBANTE.ND_B, TIPO_COMPROBANTE.RECIBO_B],
    [TIPO_COMPROBANTE.FACTURA_C]: [TIPO_COMPROBANTE.NC_C, TIPO_COMPROBANTE.ND_C, TIPO_COMPROBANTE.RECIBO_C],
    [TIPO_COMPROBANTE.FACTURA_M]: [TIPO_COMPROBANTE.NC_M, TIPO_COMPROBANTE.ND_M, TIPO_COMPROBANTE.RECIBO_C],
  };
