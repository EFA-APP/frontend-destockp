...
const ModalHistorialChequePropio = ({ cheque, onClose }) => {
  ...
  const { data, isLoading } = useHistorialChequePropioQuery(
    cheque.codigo,
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg bg-white rounded-xl shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200 max-h-[85vh]">
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          <div className="p-4 bg-gray-50 border border-gray-100 rounded-md space-y-1">
          ...
          {isLoading ? (
            <p className="text-sm font-semibold text-black/40 text-center py-8">
              Cargando historial...
            </p>
