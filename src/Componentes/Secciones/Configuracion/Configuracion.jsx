      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
          ...
          <form
            ...
            className="bg-[var(--surface)] border border-[var(--border-subtle)] rounded-md p-5 shadow-md animate-in fade-in slide-in-from-right-3 duration-500"
          >
          ...
          <form
            ...
            className="bg-[var(--surface)] border border-[var(--border-subtle)] rounded-md p-5 shadow-md animate-in fade-in slide-in-from-right-3 duration-500 delay-100"
          >
            <div className="flex items-center gap-2 mb-4 border-b border-[var(--border-subtle)] pb-3">
          ...
          {(usuario?.roles?.some((r) => r.nombre.includes("Admin")) ||
            ...
            <div className="bg-[var(--surface)] border border-[var(--border-subtle)] rounded-md p-5 shadow-md animate-in fade-in slide-in-from-right-3 duration-500 delay-200">
              <div className="flex items-center gap-2 mb-4 border-b border-[var(--border-subtle)] pb-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[var(--surface-hover)] p-4 rounded-lg border border-[var(--border-subtle)] flex flex-col justify-between items-start gap-4">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-white/5 border border-white/10 hover:bg-white/10 text-[10px] font-bold text-white rounded-md transition-all uppercase tracking-wider"
                  >
                    Gestionar AFIP
                  </button>
                </div>
