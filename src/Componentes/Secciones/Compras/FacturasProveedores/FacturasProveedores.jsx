...
import { useFacturasProveedores } from "./hooks/useFacturasProveedores";
...
const FacturasProveedores = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full pt-4 md:py-6 px-2">
      {/* 1. SECCIÓN: CABECERA */}
      <EncabezadoSeccion
        ruta={"Facturas de Proveedores"}
        icono={<ComprobanteIcono />}
        volver={true}
        redireccionAnterior={"/panel/compras/listados-proveedor"}
      />
            ...
            <div className="mt-4 flex-1 flex flex-col items-center animate-in fade-in slide-in-from-right-4 duration-500 max-w-2xl mx-auto w-full px-2 md:px-0 overflow-y-auto pb-20 md:pb-0">
              <div className="w-full bg-[var(--surface)] border border-black/5 rounded-md p-5 md:p-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  {/* CAMPOS MANUALES PARA COMPRAS (Paso 2 solicitado) */}
                  <div className="grid grid-cols-2 gap-4 animate-in fade-in duration-500">
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        type="number"
                        value={manualPuntoVenta}
                        onChange={(e) => setManualPuntoVenta(e.target.value)}
                        placeholder="00001"
                        className="w-full h-14 bg-black/5 border border-black/10 rounded-md px-4 font-bold text-black focus:border-[var(--primary)] outline-none"
                      />
                    </div>
                    <div className="flex flex-col gap-2">
                      <label className="text-[11px] font-black uppercase tracking-widest text-[var(--text-muted)]">
                  ...
                  <div className="flex flex-col gap-2 animate-in fade-in duration-500">
                    <label className="text-[11px] font-black uppercase tracking-widest text-[var(--text-muted)]">
                      CAE / Referencia (Opcional)
                    </label>
                    <input
                      type="text"
                      value={manualCae}
                      onChange={(e) => setManualCae(e.target.value)}
                      placeholder="Número de CAE informado por el proveedor"
                      className="w-full h-14 bg-black/5 border border-black/10 rounded-md px-4 font-bold text-black focus:border-[var(--primary)] outline-none"
                    />
                  </div>
            ...
            <div className="flex-1 flex flex-col mt-4 items-center animate-in fade-in slide-in-from-right-4 duration-500 max-w-2xl mx-auto w-full px-2 md:px-0 overflow-y-auto pb-20 md:pb-0">
              <div className="w-full bg-[var(--surface)] border border-black/5 rounded-md p-5 md:p-8 shadow-2xl">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                  <h3 className="text-xl font-black">Seleccionar Proveedor</h3>
                  <div className="flex items-center gap-2">
                    <button
            ...
            <div className="flex-1 flex flex-col md:flex-row gap-6 animate-in fade-in slide-in-from-right-4 duration-500 overflow-y-auto pb-20 ">
              ...
              <div className="w-full md:w-[350px] shrink-0">
                <div className="text-[var(--primary)] bg-[var(--surface-hover)] rounded-md p-4 shadow-2xl sticky top-0">
                  ...
                  >
                    {cargandoCobro ? "Procesando..." : "Verificar Registro"}
